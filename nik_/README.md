# `nik_` Theme
><small>Welcome to `nik_`, your custom [**Omega Five**](https://drupal.org/project/omega) subtheme! 
...
> You'll find that the `nik_` theme has a vast coverage of inline documentation. 
...
You will find links to **Install** and **Install and set as default** listed with `nik_`.

## Customizing Libraries in `nik_`
...
nik_:
  omega:
    ...
    title: 'Default library for the nik_ theme'
    description: 'Default Omega subtheme library description. Please provide a more meaningful description (and title) for this library by editing the nik_.libraries.yml file.'
    scss:
      style/css/nik_.css: 'style/scss/nik_.scss'
  version: VERSION
  js:
    js/nik_.js: {}
  css:
...
Above, you will see the library defined as: `nik_/nik_`. 
